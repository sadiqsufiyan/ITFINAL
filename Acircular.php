...
include("connect.php");
		$sql = "select * from circular order by id desc";
	      ...
	      <td><a href="Circulars/<?php echo $row ['fileCircular'] ?>">View File</a> <a href="delete_cir.php?id=<?php echo $row['id']?>&filename=<?php echo $row['fileCircular'] ?>">    /Delete File   </a></td>
